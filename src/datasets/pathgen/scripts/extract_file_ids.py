...
if not file_id_to_wsi and snakemake.params.testing_mode:
    ...
    sample_file_ids = [
        "0001801b-54b0-4551-8d7a-d66fb59429bf",  # Sample TCGA file ID
        "000c97fb-9a07-4880-9b3a-31b85bacab5e"   # Another sample TCGA file ID
    ]
    ...
    for file_id in sample_file_ids:
        ...
        wsi_to_entries[file_id] = [{"file_id": file_id, "wsi_id": file_id_to_wsi[file_id]}]
