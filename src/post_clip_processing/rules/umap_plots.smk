rule geo_umap_plots:
    ...
    output:
        cluster_labeled=PROJECT_DIR / config["paths"]["geo_umap"] / "cluster_labeled.pdf",
        submission_date_labeled=PROJECT_DIR / config["paths"]["geo_umap"] / "submission_date_labeled.pdf",
    conda:
        "cellwhisperer"
    log:
