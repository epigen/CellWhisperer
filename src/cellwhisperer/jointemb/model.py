...
from cellwhisperer.config import config as cellwhisperer_config, model_path_from_name
        ...
        if transcriptome_model is None:
            ...
            if kwargs_transcriptome["config"]["model_type"] == "geneformer":
                ...
                transcriptome_model = UCEModel.from_pretrained(
                    cellwhisperer_config["uce_paths"]["checkpoint"],  # HuggingFace hub ID, not a local path
