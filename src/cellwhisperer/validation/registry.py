    ...
    def get_cellwhisperer_benchmarks() -> List[ValidationBenchmarkSpec]:
        ...
        return [
            ...
            ValidationBenchmarkSpec(
                ...
                dataset_kwargs={"cell_number_threshold_per_celltype": 100, "celltype_obs_colname": "cell_ontology_class"},
                processor_kwargs={},
            ...
            ValidationBenchmarkSpec(
                ...
                metadata_col="celltype",
                dataset_kwargs={"celltypes": config.get("top20_lung_liver_blood_celltypes", []), "celltype_obs_colname": "cell_ontology_class"},
                processor_kwargs={},
            ...
            ValidationBenchmarkSpec(
                ...
                dataset_kwargs={"cell_number_threshold_per_celltype": 100, "celltype_obs_colname": "organ_tissue"},
                processor_kwargs={},
            ...
            ValidationBenchmarkSpec(
                name="zshot_HumanDisease_disease_subtype",
                dataset="human_disease", 
                metadata_col="Disease_subtype",
                dataset_kwargs={"celltype_obs_colname": "Disease_subtype"},
                processor_kwargs={},
                description="Human disease subtype prediction",
                category="disease"
            ),
