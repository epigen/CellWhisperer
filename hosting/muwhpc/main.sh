...
cellxgene launch --debug -v -p 5006  --host 0.0.0.0 --max-category-items 500 --backed ~/cellwhisperer/results/archs4_metasra/cellwhisperer_clip_v1/cellxgene.h5ad  "http://localhost:8910/api" &
